document.addEventListener("DOMContentLoaded", () => {
    const backgrounds = document.querySelectorAll('.hero-media .hero-bg');
    let currentIndex = 0;
...
document.addEventListener('DOMContentLoaded', () => {
    ...
    const translations = {
        id: {
            ...
            navEvents: 'Acara',
            navMaps: 'Kuis',
            navLanguage: 'Bahasa Indonesia',
            navLanguageEN: 'Bahasa English',
            heroEyebrow: 'Selamat Datang',
            heroTitle: 'Bandung',
            heroSubtitle: 'Kota Pintar Kreatif',
            ...
            statDestinasiTitle: 'Destinasi',
            statDestinasiDesc: 'Tempat wisata menakjubkan',
            statKulinerTitle: 'Kuliner',
            statKulinerDesc: 'Cita rasa khas Bandung',
            statEventTitle: 'Event',
            statEventDesc: 'Event menarik setiap tahun',
            ...
            event1Title: "Festival Kuliner Bandung",
            event1Desc: "Festival kuliner terbesar di Bandung dengan berbagai hidangan khas dan kreatif dari lokal hingga internasional.",
            event1Location: "Lap. Gasibu, Bandung",
            event1Time: "10.00 - 22.00 WIB",
            event1Button: "Selengkapnya",
            event2Title: "Malam Seni & Budaya",
            event2Desc: "Malam penuh seni dan budaya dengan pertunjukan musik, tari, pameran seni, dan workshop kreatif.",
            event2Location: "Taman Cikapundung",
            event2Time: "18.00 - 23.00 WIB",
            event2Button: "Selengkapnya",

            event3Title: "Pameran Kota Pintar",
            event3Desc: "Pameran teknologi dan inovasi kota pintar untuk masa depan Bandung yang lebih maju dan berkelanjutan.",
            event3Location: "Trans Convention Center",
            event3Time: "09.00 - 17.00 WIB",
            event3Button: "Selengkapnya",
        ...
        en: {
            ...
            navEvents: 'Events',
            navMaps: 'Maps',
            navLanguage: 'Language Indonesia',
            navLanguageEN: 'Language English',
            ...
            statDestinasiTitle: 'Destinations',
            statDestinasiDesc: 'Amazing places to visit',
            statKulinerTitle: 'Culinary',
            statKulinerDesc: 'Bandung’s signature flavors',
            statEventTitle: 'Events',
            statEventDesc: 'Exciting events every year',
            ...
            event1Title: "Bandung Food Fest",
            event1Desc: "Bandung's largest culinary festival featuring a wide variety of local and international signature dishes and creative cuisine.",
            event1Location: "Gasibu Square, Bandung",
            event1Time: "10:00 AM - 10:00 PM",
            event1Button: "Learn More",

            // Event Card 2
            event2Title: "Art & Culture Night",
            event2Desc: "An evening filled with art and culture featuring music performances, traditional dances, art exhibitions, and creative workshops.",
            event2Location: "Cikapundung Park",
            event2Time: "6:00 PM - 11:00 PM",
            event2Button: "Learn More",

            // Event Card 3
            event3Title: "Smart City Expo",
            event3Desc: "A technology and smart city innovation exhibition showcasing Bandung's vision for a more advanced and sustainable future.",
            event3Location: "Trans Convention Center",
            event3Time: "9:00 AM - 5:00 PM",
            event3Button: "Learn More",
